...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Admin | Examinadores Desativados</title>
    ...
    <body class="page-header-fixed" ng-app="wingoo">
        ...
        <main class="page-content content-wrap">
            ...
            <!-- HOME -->
            <div class="page-inner" ng-controller="examinadorControllerMorto">
                <div id="main-wrapper">
                    <div class="panel panel-white">
                                <div class="panel-body">
                                <h2 style="text-align:center; display:block;">Examinadores Desativados</h2>
														  ...
														  <div class="modal-dialog modal-sm">
														    ...
														    <div class="modal-content">
														      <div class="modal-header">
														        ...
														        <h4 class="modal-title">Reativar Examinador</h4>
														      </div>
														      <div class="modal-body">
														        <p>Tem certeza que deseja reativar este Examinador?</p>
														      </div>
														      <div class="modal-footer">
														        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
														        <a type="button" class="btn btn-danger" href="reativarExaminador?idExm={{idmodal}}">Confirmar</a>
														      </div>
														    </div>
														  </div>
														</div>
